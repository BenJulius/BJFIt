    ...
    <div className={`character-stage relative ${shellSize} w-full overflow-hidden rounded-2xl border border-slate-200 bg-slate-950 text-white shadow-xl dark:border-white/10`}>
      ...
      >
        <svg viewBox="0 0 200 240" className="h-full w-full drop-shadow-2xl" role="img" aria-label={`${character.name} training companion`}>
          ...
          />
          <motion.path
            d="M128 178 C138 199 142 214 137 226 C126 230 116 219 112 198"
            fill="none"
            stroke={character.accent}
            strokeWidth={quadWidth}
            strokeLinecap="round"
          ...
          <motion.path
            d="M66 116 C46 123 34 135 29 154"
            fill="none"
          ...
          />
          <motion.path
            d="M134 116 C154 123 166 135 171 154"
            fill="none"
            stroke={character.fur}
            strokeWidth={armWidth}
            strokeLinecap="round"
          ...
          <defs>
            <linearGradient id={`skin-${character.id}`} x1="0%" y1="0%" x2="0%" y2="100%">
              <stop offset="0%" stopColor="#f8d8be" />
              <stop offset="100%" stopColor="#d9a986" />
            </linearGradient>
          </defs>
      ...
      <div className="absolute inset-x-4 bottom-4 z-20">
        <div className="mb-2 rounded-xl border border-white/10 bg-black/30 p-2 text-[10px] font-black uppercase tracking-wider text-white/70">
